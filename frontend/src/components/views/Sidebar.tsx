...
interface SidebarProps {
  ...
  isAdmin: boolean;
  adminTab?: 'overview' | 'users' | 'groups' | 'resources' | 'settings';
  ...
  onViewChange: (view: 'chat' | 'agent-management' | 'admin') => void;
  onAdminTabChange?: (tab: 'overview' | 'users' | 'groups' | 'resources' | 'settings') => void;
}
