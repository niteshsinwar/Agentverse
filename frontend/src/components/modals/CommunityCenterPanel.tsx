      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-full md:w-4/5 lg:w-3/4 bg-white dark:bg-gray-900 shadow-2xl z-50 overflow-hidden flex flex-col"
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 text-white p-6 flex-shrink-0">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {sortedItems.map((item) => (
                      <motion.div
                        ...
                        className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow overflow-hidden group"
                      >
                        {/* Item Header */}
                        <div className="p-6 space-y-4">
                          ...
                          {item.pricing.type === 'paid' && item.pricing.revenueShare && (
                            <div className="flex items-center justify-center space-x-2 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200 dark:border-purple-800 rounded-xl p-3">
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <button
                              ...
                              className="flex items-center justify-center space-x-2 px-4 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-xl font-medium transition-all transform hover:scale-105"
                            >
                              <ArrowDownTrayIcon className="w-4 h-4" />
                              <span>Install</span>
                            </button>
                            <button className="flex items-center justify-center space-x-2 px-4 py-2.5 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl font-medium transition-colors">
              ...
              {activeTab === 'my-items' && (
                <div className="p-6">
                  <div className="text-center py-16">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Your Submissions</h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-6">
                      Tools, MCPs, and Agents you've shared with the community
                    </p>
                    <button className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-xl font-medium transition-all">
                ...
                <div className="p-6">
                  <div className="max-w-3xl mx-auto space-y-6">
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-gray-700 dark:text-gray-300">Verified badge for quality items</span>
                            </div>
                            <div className="flex items-center space-x-2">
                              <CurrencyDollarIcon className="w-5 h-5 text-green-500" />
                              <span className="text-gray-700 dark:text-gray-300">70/30 revenue split</span>
                            </div>
                            <div className="flex items-center space-x-2">
                              <UserGroupIcon className="w-5 h-5 text-green-500" />
                              <span className="text-gray-700 dark:text-gray-300">Reach 10K+ developers</span>
                            </div>
                            <div className="flex items-center space-x-2">
                              <SparklesIcon className="w-5 h-5 text-green-500" />
                              <span className="text-gray-700 dark:text-gray-300">Premium badge visibility</span>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 space-y-6">
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white">Submit New Item</h3>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          {[
                            { type: 'tool', icon: CodeBracketIcon, label: 'Tool', color: 'blue' },
                            { type: 'mcp', icon: ServerIcon, label: 'MCP Server', color: 'purple' },
                            { type: 'agent', icon: CpuChipIcon, label: 'Agent', color: 'indigo' },
                          ].map((item) => (
                            <button
                              key={item.type}
                              className="flex flex-col items-center space-y-2 p-4 border-2 border-gray-200 dark:border-gray-600 rounded-xl hover:border-purple-500 transition-colors"
                            >
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <button className="flex items-center justify-center space-x-2 p-4 border-2 border-gray-200 dark:border-gray-600 rounded-xl hover:border-green-500 transition-colors">
                              <span className="text-2xl">🎁</span>
                              <span className="font-medium">Free</span>
                            </button>
                            <button className="flex items-center justify-center space-x-2 p-4 border-2 border-purple-500 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                              <CurrencyDollarIcon className="w-5 h-5 text-purple-600" />
                              <span className="font-medium text-purple-600">Paid (70% revenue)</span>
                            </button>
                          </div>
                        </div>
                      ...
                      {/* Submit Button */}
                      <button className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-xl font-bold text-lg transition-all transform hover:scale-105">
                        🚀 Submit for Review
                      </button>
            ...
            {showComments && selectedItem && (
              ...
              >
                <motion.div
                  ...
                  className="bg-white dark:bg-gray-800 rounded-2xl max-w-4xl w-full max-h-[80vh] overflow-hidden flex flex-col"
                >
                  {/* Modal Header */}
                    ...
                    <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                      ...
                      <div className="flex items-center justify-between mt-3">
                        <div className="flex items-center space-x-2">
                          ...
                          {[1, 2, 3, 4, 5].map((star) => (
                            <StarIcon key={star} className="w-6 h-6 text-gray-400 hover:text-yellow-500 cursor-pointer transition-colors" />
                          ))}
                        </div>
                        <button className="px-6 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg font-medium transition-all">
                          Post Comment
                        </button>
                      </div>
                    </div>
