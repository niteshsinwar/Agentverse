...
import { BrandedCard, BrandedBadge } from '../shared/BrandedComponents';
...
export const HelpPanel: React.FC<HelpPanelProps> = ({ isOpen, onClose }) => {
  ...
  const helpSections: HelpSection[] = [
    ...
    },
    {
      ...
      icon: CpuChipIcon,
      description: 'Step-by-step guide to configuring and maintaining AI agents',
      content: (
        <div className="space-y-6">
          <div className="mb-6">
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-2">Agent Management Guide</h2>
            <p className="text-slate-600 dark:text-slate-400">
              Learn how to configure powerful AI agents, manage personalities, and align tools or MCP servers to their missions.
            </p>
          </div>
