...
export const settingsApi = {
  ...
  // Embedding compatibility check (lock-key problem detection)
  async checkEmbeddingCompatibility(): Promise<EmbeddingCompatibility> {
    return httpClient.get<EmbeddingCompatibility>('/api/v1/config/settings/embeddings/compatibility/');
  },
};