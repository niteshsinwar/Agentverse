...
export const LogViewer: React.FC<LogViewerProps> = ({ sessionId, className = '' }) => {
  ...
  const eventCategories = {
    system: ['system_event', 'group_operation', 'settings_change', 'agent_management'],
    communication: ['message_sent', 'message_received', 'message', 'agent_thought', 'agent_call'],
    tools: ['tool_called', 'tool_result', 'tool_call', 'tool_created', 'tool_updated', 'tool_deleted'],
    mcp: ['mcp_called', 'mcp_result', 'mcp_call', 'mcp_created', 'mcp_updated', 'mcp_deleted'],
    documents: ['document_uploaded', 'document_processed', 'document_processing'],
    rag: ['rag_retrieval'],
    summarization: ['summarization'],
    errors: ['error_occurred', 'error']
  };
